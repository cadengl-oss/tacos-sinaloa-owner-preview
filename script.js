const copy={
  ...
  es:{choose_counter:"Elige tu mostrador",choose_title:"Taquería / Carnicería",availability_short:"La disponibilidad cambia diariamente. Llama para confirmar el menú de hoy.",call_kitchen:"Llamar a cocina ↗",today_selection:"Selección de hoy",counter_short:"Llama o visítanos para preguntar qué hay disponible hoy.",call_counter:"Llamar al mostrador ↗",reviews_title:"Reseñas y fotos de clientes",reviews_copy:"Mira comentarios recientes, fotos de clientes y novedades antes de visitarnos.",service_note:"Comer aquí · Para llevar",menu:"Menú",call:"Llamar",call_now:"Llamar ↗",directions:"Cómo llegar ↗",directions_short:"Direcciones",hours:"Horario",daily:"Lunes — Domingo",location:"Ubicación",phone:"Teléfono",call_menu:"Llama para confirmar el menú de hoy",intro_title:"Taquería y Carnicería",intro_copy:"Comida mexicana de la cocina y una carnicería bajo un mismo techo sobre Valley Blvd.",kitchen:"Desde la cocina",menu_title:"Menú",menu_note:"La disponibilidad cambia diariamente. Llama para confirmar el menú de hoy.",today_menu:"Menú de hoy",counter:"Desde el mostrador",counter_title:"Carnicería",counter_copy:"Una carnicería del barrio junto a la taquería. Llama o visítanos para preguntar por la selección de hoy.",ask_counter:"Pregunta en mostrador ↗",visit:"Visítanos",visit_title:"Valley Blvd., Fontana"}
};
let lang="en";
